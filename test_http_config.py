...
eth2 = device[0].ethernets.ethernet()[-1]
eth1.mac = "00:00:00:00:66:01"
eth1.name = "eth_r2"
eth1.mtu = 1000

ipv4_2 = eth2.ipv4_addresses.ipv4()[-1]
ipv4_2.name = "ipv4_2"
ipv4_2.address = "10.1.1.3"
ipv4_2.prefix = 24
ipv4_2.gateway = "10.1.1.2"
...
#http_client_cmd[0] = http_client[0].commands.add("get").add("get")
#http_client_cmd[0].page = "/1b.html"
...
p1 = f1.trasaction().http.get().post()

tx[0].destination = htpp_server[0].name
tx[0].request = "get"
tx[0].url = "/b.html"
tx[0].responce = 200
